...
class Account(Base):
    ...
    # SimpleFIN: institution refresh time (balance-date) that this account's imported
    # transactions are known complete through. Drives the next sync's start-date.
    sync_covered_through = Column(DateTime, nullable=True)
